...
import com.shashikdm.givlyf.api.CreatePostRequest;
import com.shashikdm.givlyf.api.CreatePostResponse;
import com.shashikdm.givlyf.api.User;
import com.shashikdm.givlyf.utils.CustomSnackbar;
import com.shashikdm.givlyf.utils.MapUtils;
...
public class CreatePostDialog extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alertDialog.setOnShowListener(dialog -> {
            ...
            FloatingActionButton addButton = getActivity().findViewById(R.id.addRequestButton);
            ...
            alertDialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(v -> {
                ...
                if (title.isEmpty()) {
                    Toast.makeText(activity, "Please give a title", Toast.LENGTH_SHORT).show();
                    return;
                }
